...
import StatsUserDelay from './StatsUserDelay';
...
function Stats() {
    ...
    const { fetchDelayStats, fetchRouteStats, fetchStationStats, fetchUserDelay, addUserDelay, deleteUserDelay } = useContext(TrainContext);
    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                {showSelected.id == 3 && <StatsUserDelay statsDelay={statsDelay} statsRoute={statsRoute} statsStations={statsStation} fetchUserDelay={fetchUserDelay} addUserDelay={addUserDelay} deleteUserDelay={deleteUserDelay} />}
